...
parser.add_argument('--gpu', default='6', type=str, help='selected gpu')
...
def main():
    ...
    for epoch in range(opt.epochs):
        ...
        adjusting_learning_rate(optimizer, epoch)
...
if __name__=="__main__":
    ...
    basename = '-'.join(['exp', opt.dataset, opt.arch, datetime.now().strftime("%d-%H-%M-%S")])
